...
<div class="header fixed-top" style="top: 0px; padding: 20px 20px; border-bottom: 2px solid black;" id="head">
    ...
    <a href="https://neighborless-accord.000webhostapp.com/europe.php?textbox=europe" id="sub">Europe</a>
      ...
      $textboxquery= $mysqli->query("SELECT country,pictures,price FROM tbl_tourselection WHERE continent = '$textbox' OR place_city='$textbox'");
      }
    ...
    if(!empty($_GET['textbox'])){
      ...
      <img class="card-img-top" src="'.$row['pictures'].'" alt="Card image cap" style="width: 100%; height: 10em; object-fit: cover;"></a>
          <div class="card-body">
          <p class="card-text" id="para">'. $row['country'] .'<hr><p>Php '. number_format($row['price']) .'</p><a class="d-flex justify-content-end" href="" style="color: black; text-decoration:none;">View Itinerary<svg width="1em" height="1.7em" viewBox="0 0 16 16" class="bi bi-chevron-double-right" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
       ...
       for($a=$start; $a<count($countries); $a++){
         ...
         <img class="card-img-top" src="'.$pics[$a].'" alt="Card image cap" style=" width: 100%; height: 13em; object-fit: cover;"></a>
             <div class="card-body">
             <p class="card-text" id="para">'. $countries[$a] .'<hr><p>Php '. $prices[$a] .'</p><a class=" d-flex justify-content-end" href="'.$hrefs[$a].'" <a href="" style="color: black; text-decoration:none;">View Itinerary <svg width="1em" height="1.7em" viewBox="0 0 16 16" class="bi bi-chevron-double-right" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M3.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L9.293 8 3.646 2.354a.5.5 0 0 1 0-.708z"/>
  <path fill-rule="evenodd" d="M7.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L13.293 8 7.646 2.354a.5.5 0 0 1 0-.708z"/>
</svg></a>
             </p>
