  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <form action="booknow..php" method="POST" id="form">
          <div class="form-row">
            <div class="col-md-9">
