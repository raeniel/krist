...
<div class="header fixed-top" style="top: 0px; padding: 20px 20px; border-bottom: 2px solid black;" id="head">
    ...
    <a href="https://neighborless-accord.000webhostapp.com/europe.php?textbox=europe" id="sub">Europe</a>
      ...
      $textboxquery= $mysqli->query("SELECT country,pictures,href FROM tbl_tourselection WHERE continent = '$textbox' OR place_city='$textbox'");
      }
    ...
    if(!empty($_GET['textbox'])){
      ...
      <img class="card-img-top" src="'.$row['pictures'].'" alt="Card image cap" style="width: 100%; height: 10em; object-fit: cover;"></a>
          <div class="card-body">
          <p class="card-text" id="para">'. $row['country'] .'<hr><p>phew phew phew</p><a class="d-flex justify-content-end" href="'.$row['href'].'" style="color: black; text-decoration:none;">View Itinerary<svg width="1em" height="1.7em" viewBox="0 0 16 16" class="bi bi-chevron-double-right" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
